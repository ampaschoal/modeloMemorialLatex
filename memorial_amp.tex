...
\begin{enumerate}
        ...
        \begin{itemize}
                ...
                \item Iniciação científica no laboratório Laboratório de Química Medicinal e Computacional sob orientação do Prof. Dr. Adriano D. Andricopulo no período de janeiro à dezembro de 2009. \mbox{\sffamily{\bfseries{[Doc. \ref{diplomas:IC}]}}} \\ 
        \end{itemize}
        ...
        \begin{itemize}
                ...
                \item Pós-doutorando junto à Faculdade de Medicina de Ribeirão Preto (FMRP-USP) de Fevereiro à Dezembro de 2020. \mbox{\sffamily{\bfseries{[Doc. \ref{diplomas:posdoc1}]}}}\\
                \item Estágio de pesquisador junto ao Instituto de Radiologia (InRad) da Faculdade de Medicina da Universidade de São Paulo (FMUSP) desde Janeiro de 2021 até o presente momento. \mbox{\sffamily{\bfseries{[Doc. \ref{diplomas:posdoc2}]}}} \\
        \end{itemize}
        ...
        \begin{itemize}
                \item Estagiário na empresa SAPRA-Landauer no período de 08 de fevereiro à 07 de dezembro de 2012 \mbox{\sffamily{\bfseries{[Doc. \ref{declaracao:SAPRA}]}}}
        \end{itemize}
...
\item   \textbf{Nível:} Treinamento Técnico - Nível V \mbox{\sffamily{\bfseries{[Doc. \ref{bolsas:TTV}]}}} \\
